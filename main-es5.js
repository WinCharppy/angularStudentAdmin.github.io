...
var StudentFilterPipe = /** @class */ (function () {
    ...
    StudentFilterPipe.prototype.transform = function (students, searchTerm) {
        if (!students || !searchTerm) {
            return students;
        }
        return students.filter(function (student) {
            return student.FirstName.toLowerCase().indexOf(searchTerm.toLowerCase()) !== -1;
        });
    };
...
var CreateCanDeactivateGuardService = /** @class */ (function () {
    function CreateCanDeactivateGuardService() {
    }
    CreateCanDeactivateGuardService.prototype.canDeactivate = function (component) {
    ...
    return CreateCanDeactivateGuardService;
}());
...
var StudentServiceService = /** @class */ (function () {
    ...
    StudentServiceService.prototype.getStudentItem = function (id) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(this.listStudents.find(function (e) { return e.id === id; }));
    };
...
var CreateStudentComponent = /** @class */ (function () {
    function CreateStudentComponent(_studentservice, _route) {
    ...
    CreateStudentComponent.prototype.ngOnInit = function () {
        ...
        this._route.paramMap.subscribe(function (parameterMap) {
            var transferredId = +parameterMap.get('id');
            _this.getStudent(transferredId);
        });
    };
    CreateStudentComponent.prototype.getStudent = function (id) {
        var _this = this;
        if (id === 0) {
            this.isCreate = true;
            this.student = {
            ...
            this._studentservice.getStudentItem(id).subscribe(function (item) {
                _this.student = item;
            });
        }
    };
    CreateStudentComponent.prototype.saveStudent = function () {
        var _this = this;
        if (this.student.id === null) {
            //Get current max id of the listStudents
            var maxid = this._studentservice.listStudents.reduce(function (e1, e2) {
            ...
            this._studentservice.getStudentItem(this.student.id).subscribe(function (founditem) {
                founditem = _this.student;
            });
        }
    };
...
var DetailStudentComponent = /** @class */ (function () {
    function DetailStudentComponent(_route, _studentservice) {
        this._route = _route;
        this._studentservice = _studentservice;
    }
    DetailStudentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._route.paramMap.subscribe(function (transferredItem) {
            var parsedId = +transferredItem.get('id');
            _this._studentservice.getStudentItem(parsedId).subscribe(function (data) { return _this.student = data; });
        });
    };
    DetailStudentComponent.ctorParameters = function () { return [
...
var DisplayStudentComponent = /** @class */ (function () {
    function DisplayStudentComponent(_router, _studentservice) {
        this._router = _router;
        this._studentservice = _studentservice;
    }
    DisplayStudentComponent.prototype.ngOnInit = function () {
    };
    DisplayStudentComponent.prototype.viewStudent = function () {
        this._router.navigate(['/student', this.student.id]);
    };
    DisplayStudentComponent.prototype.editStudent = function () {
        this._router.navigate(['/edit', this.student.id]);
    };
    DisplayStudentComponent.prototype.deleteStudent = function (id) {
        var i = +this._studentservice.listStudents.findIndex(function (e) { return e.id === id; });
        this._studentservice.listStudents.splice(i, 1);
    };
    DisplayStudentComponent.ctorParameters = function () { return [
...
var ListStudentsComponent = /** @class */ (function () {
    function ListStudentsComponent(_studentservice) {
        this._studentservice = _studentservice;
        this.students = [];
    }
    ListStudentsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._studentservice.getStudents().subscribe(function (data) {
            _this.students = data;
        });
    };
